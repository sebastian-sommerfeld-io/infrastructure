...
|[[requirement_docker]] <<requirement_docker,docker>> |2.16.0
...
|[[provider_docker]] <<provider_docker,docker>> |2.16.0
...
|https://registry.terraform.io/providers/kreuzwerker/docker/2.16.0/docs/resources/image[docker_image.docs-image] |resource
...
|https://registry.terraform.io/providers/kreuzwerker/docker/2.16.0/docs/data-sources/registry_image[docker_registry_image.docs-image] |data source
