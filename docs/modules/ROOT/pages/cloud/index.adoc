...
|===
|Ddomain |Provider |Target
|apps.sommerfeld.io |tbd |Reserved for different cloud (similar to `cloud`)
|cloud.sommerfeld.io |DigitalOcean |Used for DNS settings -> NS records point to http://ns1.digitialocean.com, http://ns2.digitialocean.com and http://ns3.digitialocean.com.
