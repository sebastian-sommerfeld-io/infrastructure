...
|===
|(Sub-) Domain |Provider |Type |Target
|apps |tbd |KAS Subdomain |Reserved for different cloud (similar to `cloud`)
|cloud |DigitalOcean |KAS Subdomain |Used for DNS settings -> NS records point to http://ns1.digitialocean.com, http://ns2.digitialocean.com and http://ns3.digitialocean.com.
|linode |Linode |KAS Subdomain |Reserved for Linode (similar to `cloud`)
|===
