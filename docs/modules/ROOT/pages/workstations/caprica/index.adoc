...
CAUTION: todo ... (Ubuntu with Vagrant vs Proxmox ???) -> Don't use Vagrant at all and run containers directly (because Jenkins should be able to start/stop Vagrantboxes)?!
