...
|Documentation |https://docs.cloud.sommerfeld.io/{project-name}/main
|===
...
Public sites are divided into two parts. The first part is hosted traditionally by a classic hosting provider and the second part is hosted in the cloud (by default at DigitalOcean, see xref:ADRs:architecture-decision-records/cloud-provider.adoc[]).

For information on the DigitalOcean setup take a look at the "xref:cloud/index.adoc[]" page.
