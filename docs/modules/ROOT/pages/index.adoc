...
. Merge and delete repo kobol-scripts
. Merge and delete repo kobol-vagrant
. Merge and delete repo homelab
. Update Jira components and board to infrastructure??
...
.. Allow other prjoects, to load these assets into their respective repo (each project takes care of this on its own)
